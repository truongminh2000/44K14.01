											...
											<div class="form-group">
												...
												<div>
													...
													<textarea rows="6" name="description" class="form-control"
														placeholder="Nhập mô tả">${post.description}</textarea>
													<form:errors path="post.description" cssStyle="color:red"
														cssClass="error" />
												</div>
												<br>
												<div>
													<label for="area">Diện tích (Đơn vị: m2)</label> <input
												...
												<br>
												<div>
													<label for="addDetail">Số nhà</label> <input type="text"
												...
												<div>
													...
													<div class="form-control">
														<select class="phuong--list" name="ward.wid">
															<option class="form-control" value="0">Chưa có
																phường!</option>
														</select>
													</div>
												</div>
												<br>
												<div>
													<label for="file">Hình ảnh</label> <input type="file"
												...
												<br> <input type="submit" value="Thêm"
													...
													type="reset" value="Nhập lại" class="btn btn-default" /> <a
													style="background-color: #DD5872; border: none; color: #fff;"
													class="btn btn-default"
													href="${pageContext.request.contextPath}/user/index.html">Hủy</a>
											</div>
										</div>
									</div>
									<hr>
